...
While OBD data can only be collected while the car's engine is running, the phone's other
sensors can still be used to collect data from its built-in sensors. Furthermore,
