...
Although this could have been done during the building of the platform, 
we didn't want to change the stock platform to keep the application development process as simple as possible.

The sensing application was written in 291 loc using the available API's provided by the Android framework. 
...
send cycle quickly comparable to Tiny Sensor, This is seen in the high current draw phase 
...
radio interfaces to connect to connect to a network after one of the interfaces is disconnected. 
