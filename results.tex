...
\begin{equation}\label{label_exptime}
    E(T)_{hrs} = \frac{C_{Batt}}{I_{idle} + s*I_{sense} + t*I_{transmit}}
\end{equation}
where:
{\small
\begin{itemize}[label=]
...
Plugging in the current draw values for each of the phases measured in our experiments, the expected lifetime for our sensing application would be 0.619298


%\input{./figures/currenttable.tex}
